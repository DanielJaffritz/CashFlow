...
const SignUp = () => {
  ...
  return (
    <section className='flex justify-center items-center w-screen h-screen p-20'>
      <div className='bg-white flex flex-col justify-center items-center rounded-2xl shadow-2xl p-3'>
        ...
        <form id='upload-form' onSubmit={handleSubmit} className='flex flex-col justify-center items-center gap-3 w-full p-5 md:px-20' >
          ...
          <input type='text' name='username' id='username' placeholder='username' className='w-full p-3 rounded-md border-2 border-gray-300'></input>
          ...
          <input type='text' name='confirm-password' id='confirm-password' placeholder='Confirm Password' className='w-full p-3 rounded-md border-2 border-gray-300'></input>
          <h2 className='text-red-400'>{statusText}</h2>
          <Link to='/SignIn'>
            already have an account?
          </Link>
          <button className=' text-white bg-amber-400 p-5 rounded-4xl hover:text-black cursor-pointer w-full ' type='submit'>Register</button>
        </form>
