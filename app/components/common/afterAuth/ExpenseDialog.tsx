...
const ExpenseDialog = ({ isOpen, setIsOpen }: DialogProps) => {
  ...
  return (
    <dialog open closedby="any" onClose={() => setIsOpen(false)} className='transition-all flex flex-col w-150 h-180 shadow-2xl rounded-2xl fixed top-[50%] left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%]'>
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <form onSubmit={HandleSubmit}>
          ...
          <div className="flex flex-row justify-between p-5">
            <button className='outline outline-zinc-400 hover:bg-zinc-400 mr-5 rounded-md cursor-pointer' type="reset">Cancel</button>
