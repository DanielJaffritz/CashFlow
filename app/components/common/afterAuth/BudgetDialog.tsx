...
const BudgetDialog = ({ isOpen, setIsOpen }: DialogProps) => {
  ...
  return (
    <dialog open closedby="any" onClose={() => setIsOpen(false)} className='transition-all flex flex-col w-3/4 md:w-1/2 h-2/3 md:h-5/6 rounded-2xl fixed top-[50%] left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%]'>
        ...
        <form onSubmit={HandleSubmit} className="flex flex-col justify-center items-center">
          ...
          <div className="flex flex-row justify-between px-5 w-full">
            <div className="flex flex-col w-35 md:w-full">
              ...
              <select defaultValue='' id="category" name="category" required className=' outline-zinc-400 rounded-md p-3 mr-1 md:mr-5 border border-zinc-200 bg-bg-app cursor-pointer'>
            ...
            <div className="flex flex-col w-35 md:w-full">
              ...
              <select defaultValue='' id="duration" name="duration" required className=' outline-zinc-400 rounded-md p-3 mr-1 md:mr-5 border border-zinc-200 bg-bg-app cursor-pointer' >
          ...
          <div className="flex flex-row justify-between p-5">
            <button className='outline outline-zinc-400 p-3 mr-5 rounded-md cursor-pointer' type="reset">Cancel</button>
            <button className="bg-amber-400 w-full p-3 rounded-md cursor-pointer" type="submit">Save budget</button>
          </div>
